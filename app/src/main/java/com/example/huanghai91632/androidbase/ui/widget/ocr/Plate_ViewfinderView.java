 ...
 *
 */
public class Plate_ViewfinderView extends View {
	...
	public Plate_ViewfinderView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public Plate_ViewfinderView(Context context){
		super(context);
		// TODO Auto-generated constructor stub
		this.mContext = context;
	}

	public Plate_ViewfinderView(Context context, AttributeSet attrs, int defStyle) {
	...
	//	int public_100_dp=getResources().getIdentifier("public_100_dp", "dimen", "android.com.yunmai.cc.idcard.base");
		marginT = 333;
