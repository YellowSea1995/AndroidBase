 ...
 *
 */
public class ID_ViewfinderView extends View {
	...
	public ID_ViewfinderView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public ID_ViewfinderView(Context context){
		super(context);
		// TODO Auto-generated constructor stub
		this.mContext = context;
	}

	public ID_ViewfinderView(Context context, AttributeSet attrs, int defStyle) {
	...
	//	int public_30_dp=getResources().getIdentifier("id_camera_sv", "dimen", "android.com.yunmai.cc.idcard.base");
		marginT = 100;
